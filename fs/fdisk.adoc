...
参考 http://dreamfire.blog.51cto.com/418026/1084729/[这里]
...
http://serverfault.com/questions/6714/how-to-make-windows-7-usb-flash-install-media-from-linux[Win7 ISO -++>++ U盘]
...
* http://www.hackintosh.com/[Hackintosh]

...
然后浏览器访问: - 用户名/密码: admin/test - http://localhost:8080/flowable-idm/ - http://localhost:8888/flowable-modeler/ - http://localhost:9988/flowable-admin/ - http://localhost:9999/flowable-task/

=== 参考

* https://www.flowable.org/[Flowable]
* https://www.flowable.org/docs/userguide/index.html#springintegration[spring integration]

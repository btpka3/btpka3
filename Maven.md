...
根据数据库结构、生成MyBatis查询接口、查询接口、实体bean。
            ...
            <executions>
              ...
              <execution>
                ...
                <configuration>
                  <target>
                    <delete>
                      <fileset dir="${basedir}/src/main/resources/ibatis" includes="**/*Dao.xml">
                      </fileset>
                    </delete>
                  </target>
                </configuration>
              ...
              <execution>
                ...
                <configuration>
                  <target>
                    <move todir="${basedir}/../tcgroup-his-api/src/main/java/com/tc/his/api/model">
                      <fileset dir="${basedir}/src/main/java/com/tc/his/api/model">

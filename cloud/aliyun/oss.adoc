...
ossutil stat oss://bundle-repository/log/dangqian.zll/hello.txt
----
...
[source,shell]
----
# 获取所有oss对象实例链接的endpoint 和 ak
vmtool -x 3 --action getInstances --className com.aliyun.oss.OSSClient  --express 'instances.{endpoint}'
----

...
https://docs.groovy-lang.org/latest/html/api/org/codehaus/groovy/runtime/DefaultGroovyMethods.html#getAt(java.util.Collection,java.lang.String)[more syntactic sugar and eventually calls into DefaultGroovyMethods.getAt(Collection&#44; String).]
...
see http://www.groovy-lang.org/design-patterns.html#_pimp_my_library_pattern[here]
...
see groovy issue https://issues.apache.org/jira/browse/GROOVY-3278[2178]. 只能先在Java中定义常量，再在groovy中引用。

=== 添加新方法

==== 为类添加静态方法

* http://groovy.codehaus.org/ExpandoMetaClass[ExpandoMetaClass]
* http://groovy.codehaus.org/JN3525-MetaClasses[MetaClasses]
* http://groovy.codehaus.org/Per-Instance+MetaClass[Per-Instance MetaClass]
* http://stackoverflow.com/questions/24169976/understanding-groovy-grails-classloader-leak[Understanding Groovy/Grails classloader leak]
* http://stackoverflow.com/questions/23121890/difference-between-delegate-mixin-and-traits-in-groovy[Difference between @Delegate&#44; @Mixin and Traits in Groovy?]
* http://groovy.329449.n5.nabble.com/Metaclass-methods-protecte-objects-from-gc-is-this-a-bug-td368195.html[Metaclass methods protecte objects from gc&#44; is this a bug?]
* http://groovy.329449.n5.nabble.com/MetaClass-gc-ing-td381842.html[MetaClass gc’ing]

per-Instance 与 其 metaClass 存储在 https://github.com/groovy/groovy-core/blob/master/src/main/org/codehaus/groovy/reflection/ClassInfo.java#L384[org.codehaus.groovy.reflection.ClassInfo#perInstanceMetaClassMap] 中，参见348行。
...
参考： http://groovy-lang.org/metaprogramming.html#developing-ast-xforms[Developing AST transformations]
...
必须在 http://docs.groovy-lang.org/2.4.8/html/gapi/index.html?org/codehaus/groovy/control/CompilePhase.html[org.codehaus.groovy.control.CompilePhase] 中定义的9个阶段完成

===== AST 类型检查

请参考 http://groovy-lang.org/dsls.html#section-delegatesto[这里]
...
see http://docs.groovy-lang.org/latest/html/documentation/type-checking-extensions.html[here]

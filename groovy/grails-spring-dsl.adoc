...
参考 《http://blog.klarshift.de/?p=160[More structure for your beans – Grails split resources.groovy]》
...
----
* 修改 scripts/++_++Events.groovy，使得分割后的文件放置到 classpath下，run-app不会出错
+
[source,groovy]
----
eventCompileEnd = { msg ->

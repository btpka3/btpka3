...
* https://kubernetes.io/zh-cn/docs/tasks/administer-cluster/kubelet-config-file/[通过配置文件设置 Kubelet 参数]
* https://kubernetes.io/zh-cn/docs/reference/config-api/kubelet-config.v1beta1/[Kubelet 配置 (v1beta1)]
...
kubectl 使用的认证信息： /etc/kubernetes/kubelet.conf

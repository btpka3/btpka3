* https://github.com/telepresenceio/telepresence[Telepresence]
* https://github.com/telepresenceio/telepresence.io/blob/master/docs/pre-release/install/index.md[install]

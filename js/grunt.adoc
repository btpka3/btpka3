同类工具参考 http://fis.baidu.com/[F.I.S]、 http://gulpjs.com/[gulp]

=== 本地缓存

https://github.com/mixu/npm_lazy[npm++_++lazy] 或者 https://github.com/rlidwka/sinopia[sinopia]

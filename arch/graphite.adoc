...
* http://graphite.readthedocs.io/en/latest/functions.html[functions]
* http://graphite.readthedocs.io/en/latest/render_api.html[The Render URL API]

=== statsd

https://github.com/etsy/statsd[statsd] 是一个简单 NodeJs 程序监听数据，并转发给 graphite

=== tessera

https://github.com/tessera-metrics/tessera[tessera] 是 graphite 的 web 前端画面，比 graphite 自带的漂亮。

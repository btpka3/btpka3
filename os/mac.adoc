...
2016 在 杭州钱皇, 公司在给配置(租赁)了一个顶配的苹果笔记本电脑给用,这是第一次正式使用苹果的设备。 下面就记录一下总结。

=== 参考

* https://code.csdn.net/micrqwe/document/file/iphoneAPN.md[苹果推送证书的设置]
* http://superuser.com/questions/279235/why-does-chown-report-operation-not-permitted-on-os-x[Why does chown report “Operation not permitted” on OS X?]
* http://stackoverflow.com/questions/32590053/copying-file-under-root-got-failed-in-os-x-el-capitan-10-11[copying file under root got failed in OS X El Capitan 10.11]
* https://www.firewolf.science/2015/09/microsoft-office-2016-for-mac-15-25-0-with-vl-license-utility/[Microsoft Office 2016 for Mac with VL License Utility V2.0]
* http://macadmins.software/[Microsoft Office 2016 for Mac Downloads]
* http://www.360.cn/mac/[360安全卫士for Mac]
* http://www.insanelymac.com/forum/files/[insanelymac.com]
* http://wiki.osx86project.org/wiki/index.php/Main_Page[osx86project]
* http://www.hackintosh.com/[hackintosh.com]
* http://jingyan.baidu.com/article/ff411625b9011212e48237b4.html[VMware 11安装Mac OS X 10.10]
* http://cvad-mac.narod.ru/index/bootdiskutility_exe/0-5[bootdiskutility.exe]
* https://clover-wiki.zetam.org/zh-CN/What-is-what[clover]

=== brew

苹果电脑并没有类似 Ubuntu 的 apt-get 或 CentOS 的 yum 命令, 但第三方提供了类似的工具 http://brew.sh/[brew]
...
Finder 上没有地址栏, 可以 FinderPath https://bahoom.com/finderpath/
...
....
. windows 电脑上访问 `++\\++192.168.0.146` (IP地址应该是你苹果电脑的IP地址)，用户名为 `guset`, 密码为空。Done.
. Linux 电脑上访问 `smb://192.168.0.146` 访问即可。
. 苹果电脑上创建共享目录：在目标目录上右键 -++>++ Get Info -++>++ 选中 "`Shared Folder`" 即可。 注意：需要在系统偏好的文件共享中更新权限。

=== windows上提供的共享目录

[arabic]
. Mac OS X -++>++ Finder -++>++ Go -++>++ Connect to Server ()

⌘、⌥、⇧、⌃、⎋

=== Android

sdk 下载 http://sdk.android-studio.org/
...
《http://inkandfeet.com/how-to-use-a-generic-usb-20-10100m-ethernet-adaptor-rd9700-on-mac-os-1011-el-capitan[Steps to get your adapter working if you just upgraded to Mac OS 10.11 El Capitan.]》 重启, Command {plus} R 进入恢复模式, 并命令行运行 `csrutil disable`

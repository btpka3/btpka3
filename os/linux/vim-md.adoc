...
彩色查看 `/Library/LaunchDaemons` 目录下文件 https://github.com/darfink/vim-plist[vim-plist]
...
http://www.drchip.org/astronaut/vim/#LARGEFILE[largeFile], http://www.drchip.org/astronaut/vim/doc/LargeFile.txt.html[Manual] wget http://www.drchip.org/astronaut/vim/vbafiles/LargeFile.vba.gz gunzip LargeFile.vba.gz vi LargeFile.vba :source %
...
参考：http://vim.wikia.com/wiki/File_format[1]

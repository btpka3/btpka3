link:www.howtoforge.com/setting-up-an-nfs-server-and-client-on-centos-5.5[Setting Up An NFS Server And Client On CentOS 5.]
...
参考http://man.ddvip.com/os/redhat9.0cut/s1-nfs-mount.html[这里]

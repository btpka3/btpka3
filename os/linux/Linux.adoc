...
http://www.walkernews.net/2008/11/21/how-to-check-what-kernel-build-options-enabled-in-the-linux-kernel/[See this]:
...
http://www.tldp.org/HOWTO/html_single/Module-HOWTO/[See this]

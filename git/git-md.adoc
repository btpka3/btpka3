* http://git-scm.com/book/zh[Git中文手册]、
* http://git-scm.com/book/zh/Git-%E5%86%85%E9%83%A8%E5%8E%9F%E7%90%86-The-Refspec[git Refspec]、
* http://stackoverflow.com/questions/4044368/what-does-tree-ish-mean-in-git/18605496#18605496[Git Commit-ish/Tree-ish]
* git工作量统计： http://btpka3.github.io/js/node/git-stat/stat/[查看]， https://github.com/btpka3/btpka3.github.com/blob/master/js/node/git-stat/[源码]

== 记住密码

使用ssh协议，可以使用ssh key来免密码登录。但是如果使用 http/https 协议来clone，则可以参考 https://help.github.com/articles/caching-your-github-password-in-git/[这里]
...
link:brew%20install%20git-lfs[git-lfs]
...
https://cms-sw.github.io/tutorial-proxy.html[参考]
...
参考: https://www.emilsit.net/blog/archives/how-to-use-the-git-protocol-through-a-http-connect-proxy/[1]、 https://gist.github.com/sit/49288[2]、 https://github.com/cms-sw/cms-git-tools/blob/master/git-proxy[git-proxy@cms-sw/cms-git-tools]
...
假如有新修改提交到本地了。在push前进行pull的时候， git自动合并并创建了一个新的commit，其注释为 "`Merge branch '`xxx`' of git@xxxx/path/to/xxx.git into xxx`"。此时，大家应当立即运行
...
OLD_EMAIL="btpka3@163.com"
CORRECT_NAME="当千"
CORRECT_EMAIL="dangqian.zll@alibaba-inc.com"
...
另外，请参考使用 link:https://github.com/newren/git-filter-repo/[git-filter-repo]

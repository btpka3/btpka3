参考阿里云关系数据库RDS服务的http://help.aliyun.com/view/11108238_13440406.html[MySQL性能测试报告]
...
|Memory |4G
|MySQL |mysqld Ver 5.5.37-0ubuntu0.12.04.1-log for debian-linux-gnu on x86++_++64 ((Ubuntu))
|===
...
|Memory |32G
|MySQL |mysql Ver 14.14 Distrib 5.6.20, for Linux (x86++_++64) using EditLine wrapper
|===

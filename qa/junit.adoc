...
== engine
JUnit Vintage : 运行junit3,junit4 已经不推荐
JUnit Jupiter : 运行junit5

link:https://docs.junit.org/6.0.0/release-notes.html[junit 6]

* 使用JDK17

== report

* link:https://maven.apache.org/surefire/maven-surefire-report-plugin/report-mojo.html[maven-surefire-report-plugin]  生成HTML格式的报告
* link:https://allurereport.org/[Allure Report]

* link:https://github.com/ota4j-team/open-test-reporting[Open Test Reporting]
* cli
** org.opentest4j.reporting.cli.ReportingCli
** org.opentest4j.reporting.cli.HtmlReportCommand

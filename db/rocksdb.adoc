...
* https://github.com/facebook/rocksdb/wiki/RocksJava-Basics[RocksJava Basics]
* https://zhuanlan.zhihu.com/p/566742456[深入浅出带你走进 RocksDB]
* https://cloud.tencent.com/developer/article/2169307[Rocksdb简介]

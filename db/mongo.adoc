...
https://github.com/btpka3/btpka3.github.com/tree/master/grails/my-mongo[MongoDB Grails示例]
...
[arabic]
. 使用定时任务定期 mapRecude 维护数据，要设计成可全量的，也可以增量的
. 管理后台需要有相关的画面来手动触发
. mapRecude 定时任务流程
...
* http://docs.mongodb.org/manual/core/map-reduce/[Mongo Map-Reduce]
* https://github.com/poiati/gmongo#mapreduce[GMongo Map-Reduce demo]
* http://stackoverflow.com/questions/5681851/mongodb-combine-data-from-multiple-collections-into-one-how/8746805#8746805[GORM Mongo Map-Reduce]

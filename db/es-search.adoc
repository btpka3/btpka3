...
官方文档的 http://www.elasticsearch.org/guide/en/elasticsearch/client/java-api/current/index.html[Java API] 参考。 第三方提供的在线 http://javadoc.kyubu.de/elasticsearch/[Javadoc]。

...
注意：从 http://dev.mysql.com/doc/refman/5.5/en/innodb-default-se.html[5.5.5] 开始，默认的存储引擎已经改为 InnoDB。

http://dev.mysql.com/doc/mysql-repo-excerpt/5.6/en/linux-installation-yum-repo.html[安装参考]
...
参考 http://dev.mysql.com/doc/refman/5.6/en/option-files.html[option-files]。 其中server可以配置的参数值参考http://dev.mysql.com/doc/refman/5.6/en/innodb-parameters.html[这里]

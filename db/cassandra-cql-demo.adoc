...
* 《http://cassandra.apache.org/doc/cql3/CQL.html[Cassandra Query Language (CQL) v3.1.7]》
* 《http://www.datastax.com/documentation/cql/3.1/cql/cql_reference/counter_type.html[CQL for Cassandra 2.x]》
* 《http://www.datastax.com/documentation/cql/3.0/cql/cql_using/use_collections_c.html[CQL for Cassandra 1.2 : Using collections]》

...
在线http://www.mysqlcalculator.com/[JS计算]
...
[width="100%",cols="8%,46%,46%",options="header",]
|===
| |test.86 |prod.80
...
|MySQL |5.5.40-0ubuntu0.12.04.1-log for debian-linux-gnu on x86++_++64 ((Ubuntu)) |mysqld Ver 5.6.20 for Linux on x86++_++64 (MySQL Community Server (GPL))
|===

=== 差别

[width="100%",cols="24%,28%,23%,25%",options="header",]
|===
|mysqld –verbose –help |default |test.86 |prod.80
|back-log |80 | |250
|character-set-server |latin1 |utf8mb4 |utf8mb4
|collation-server |latin1++_++swedish++_++ci |utf8mb4++_++unicode++_++ci |utf8mb4++_++unicode++_++ci
...
|innodb-flush-method |(No default value) | |O++_++DIRECT
...
|log-slow-queries |/var/lib/mysql/latexmath:[{hostname}-slow.log | /var/log/mysql/mysql-slow.log |                                 |
...
|sql-mode | |NO++_++ENGINE++_++SUBSTITUTION |NO++_++ENGINE++_++SUBSTITUTION
